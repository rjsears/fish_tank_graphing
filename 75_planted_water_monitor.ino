...
// This is the sketch that talks to my Adafruit Feather Huzzah microcontroller. 
// This is part of my fish tank monitoring system that includes the Atlas
// Scientific WiFi Hydroponics platform for measuring Temperature, pH and 
// Electrical Conductivity (EC in μS/cm). 
// 
//
// Eventually I will rewrite this code to write directly to my local Influx
// database, but for right now I use thingspeak.

// More information can be found at
// https://www.atlas-scientific.com/product_pages/kits/wifi.html or
// https://www.instructables.com/id/Wifi-Hydroponics-Meter/

// This code was provided by Atlas Scientific and (if necessary)
// modified by me for my personal use in my project.
//
...
const String ssid = "aquaden";                                 //The name of the Wi-Fi network you are connecting to
const String pass = "your_wifi_password_here";                             //Your WiFi network password
const long myChannelNumber = xxxxxx;                            //Your Thingspeak channel number
const char * myWriteAPIKey = "xxxxxxxxxxxxxxxxxxxx";                 //Your ThingSpeak Write API Key
//------------------------------------------------------------------
